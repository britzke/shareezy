...
public class ContextListener implements ServletContextListener {
	 ...
	 * <dd>mail.smtp.starttls - Gibt an, ob die Authentisierung mit dem SMTP-Server mittels TLS
	 * durchgeführt wird</dd>
	 * <dt>org.shareezy.MAIL_SMTP_AUTH</dt>
	 * <dd>mail.smtp.auth - Gibt an, ob eine Authentisierung mit dem SMTP-Server durchgeführt werden muss</dd>
	 * <dt>org.shareezy.MAIL_SMTP_HOST</dt>
	 * <dd>mail.smtp.host - Name des SMTP-Mailservers</dd>
	 * <dt>org.shareezy.MAIL_SMTP_PORT</dt>
	 * <dd>mail.smtp.port - Port, an dem der SMTP-Service zur Verfügung gestellt wird</dd>
	 * <dt>org.shareezy.MAIL_SMTP_USER</dt>
	 * <dd>mail.smtp.user - Name des Benutzers am SMTP-Server</dd>
	 * <dt>org.shareezy.MAIL_SMTP_WORD</dt>
	 * <dd>mail.smtp.word - Kennwort des Benutzers am SMTP-Server</dd>
	 * </dl>
	 * 
	 * Das Kontext-Attribut kann innerhalb der Applikation genutzt werden,
	 * um E-Mails mit Hilfe javax.mail-APIs zu versenden und zu empfangen.
	 * 
	...
	public void contextInitialized(ServletContextEvent e) {
		...
		ps.put("mail.smtp.auth",
				Boolean.parseBoolean(sc.getInitParameter("org.shareezy.MAIL_SMTP_AUTH")));
		ps.put("mail.smtp.starttls.enable", Boolean.parseBoolean(sc
				.getInitParameter("org.shareezy.MAIL_SMTP_STARTTLS_ENABLE")));
		ps.put("mail.smtp.host", sc.getInitParameter("org.shareezy.MAIL_SMTP_HOST"));
		ps.put("mail.smtp.port",
				Integer.parseInt(sc.getInitParameter("org.shareezy.MAIL_SMTP_PORT")));
		ps.put("mail.smtp.user", sc.getInitParameter("org.shareezy.MAIL_SMTP_USER"));
		ps.put("mail.smtp.word", sc.getInitParameter("org.shareezy.MAIL_SMTP_WORD"));
